...
- [ ] 05.1-01-PLAN.md — Migration 0018: Feld-Audit-Trigger (patients/ccps → audit_log via argus_usbnk()) + `normal`-Entsperrung (issue/role-change); Management-API-Apply-Checkpoint [Welle 1]
